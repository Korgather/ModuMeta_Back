...
//                .mvcMatcher("/api/v1/**")
                ...
                //게임 관련 API
                    .mvcMatchers(HttpMethod.POST,"/api/v1/game/omok/user/info").permitAll()
                    .mvcMatchers(HttpMethod.POST,"/api/v1/game/omok/user").hasAnyAuthority(RoleType.USER.getCode())
